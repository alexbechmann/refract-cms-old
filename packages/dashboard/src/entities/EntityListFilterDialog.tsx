...
export interface EntityListFiltersProps extends Pick<DialogProps, 'open' | 'onClose'> {
...
interface Props
  extends EntityListFiltersProps,
    WithStyles<typeof styles>,
    ReturnType<typeof mapStateToProps>,
    Readonly<typeof mapDispatchToProps> {}

const EntityListFilters: ComponentType<Props> = ({
  classes,
  schema,
  onClose,
  open,
...
function mapStateToProps(state: AppState, ownProps: EntityListFiltersProps) {
...
)(EntityListFilters) as ComponentType<EntityListFiltersProps>;
